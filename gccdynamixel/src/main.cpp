...
/** \mainpage RoboComp::dynamixecontroller
 *
 * \section intro_sec Introduction
 *
 * The dynamixecontroller component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/dynamixecontroller --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class dynamixecontroller : public RoboComp::Application
{
public:
	dynamixecontroller (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::dynamixecontroller::initialize()
{
...
int ::dynamixecontroller::run(int argc, char* argv[])
{
